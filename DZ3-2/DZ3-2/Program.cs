namespace DZ3_2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(new string('-', 30)); //строка из повторяющегося символа, спец конструкция, дефис повторится 30 раз
            ...
            // 0 - индекс первого аргумента, -25 это ширина столбца для первого значения, минусом выравниваю по левому краю
